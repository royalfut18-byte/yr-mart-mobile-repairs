        ...
        <Reveal delay={0.06}>
          <div className="mt-10 grid items-center gap-8 overflow-hidden rounded-[2rem] bg-brand p-8 text-white sm:p-12 md:grid-cols-[1.15fr_1fr] sm:rounded-[2.5rem]">
            <div>
              ...
              <div className="mt-7">
                <Pill href={business.phoneHref} tone="light" icon={<PhoneIcon className="h-[1.1rem] w-[1.1rem]" />}>
            ...
            <ul className="space-y-2.5">
              {tradePoints.map((point) => (
                <li key={point} className="flex items-start gap-3 rounded-2xl bg-white/10 px-4 py-3.5">
                  <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-white/20">
                    <svg viewBox="0 0 24 24" className="h-3 w-3" aria-hidden="true">
                      <path d="m5 12.5 4.5 4.5L19 7.5" fill="none" stroke="#fff" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </span>
